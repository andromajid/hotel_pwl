...
?>   
 <?php
    if(!empty($results))
    {
        ...
        <div class="pr">
        <a href="<?php echo $link;?>"><img src="<?php echo  Yii::app()->theme->baseUrl.'/views/layouts/';?>images/produk.png"  /></a>
        ...
        <?php
              foreach($results AS $row)
              {
                  ...
                  $imgSrc=function_lib::resizeImageMoo($newsImage,'product_thumb');
                ?>
