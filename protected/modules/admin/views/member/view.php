...
$this->menu=array(
	...
	array('label'=>'Update MlmMember', 'url'=>array('update', 'id'=>$model->member_network_id)),
	array('label'=>'Delete MlmMember', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->member_network_id),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage MlmMember', 'url'=>array('admin')),
);
?>

<h1>View MlmMember #<?php echo $model->member_network_id; ?></h1>
